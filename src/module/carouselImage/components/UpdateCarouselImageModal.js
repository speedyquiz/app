...
import { updateCarouselImageReq } from '../action/action';
//
const UpdateCarouselImageModal = (props) => {
    //
    ...
    useEffect(() => {
        ...
        setMultipleImageFile(props.data?.image);
        //
    }, [])
    //
...
export default UpdateCarouselImageModal;
